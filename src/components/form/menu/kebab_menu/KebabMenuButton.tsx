...
const KebabMenuButton = ({size, dropdownContent, tooltipContent, mountDropdown, setMountDropdown}: KebabMenuProps) => {
        ...
        <section id='kebab-container' ref={outClickRef}>
...

            {
                (isHovered) ? <TooltipManager
                    content={<span className='fs-sc-body-1 fw--semi-bold'>{tooltipContent}</span>}/> : null
            }
        </section>
    )
}
